...
class _NonClosingTextIOWrapper(io.TextIOWrapper):
    def __init__(self, stream: Any, encoding: Any, errors: Any, force_readable: bool = ..., force_writable: bool = ..., **extra: Any) -> None: ...
    def __del__(self) -> None: ...
    def isatty(self): ...

class _FixupStream:
    def __init__(self, stream: Any, force_readable: bool = ..., force_writable: bool = ...) -> None: ...
