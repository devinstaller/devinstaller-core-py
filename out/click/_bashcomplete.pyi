from .core import Argument as Argument, MultiCommand as MultiCommand, Option as Option
...
def add_subcommand_completions(ctx: Any, incomplete: Any, completions_out: Any) -> None: ...
